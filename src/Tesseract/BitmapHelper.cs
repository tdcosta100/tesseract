...
namespace Tesseract
{
    ...
    public static unsafe class BitmapHelper
    {
        ...
        /// <param name="bitmap"></param>
        /// <returns></returns>
        public static int GetBPP(System.Windows.Media.Imaging.BitmapSource bitmap)
        {
            return (bitmap.Format.BitsPerPixel != 2) ? bitmap.Format.BitsPerPixel : throw new ArgumentException(String.Format("The bitmap's pixel format of {0} was not recognised.", bitmap.Format), "bitmap");
        }
#endif
#endif
